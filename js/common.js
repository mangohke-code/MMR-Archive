...
// (보스 상세, 코스튬 상세, 도감 상세)만 쌓는다. 그래서 뒤로 가기는 늘 지금
// 보고 있는 탭 안에서만 움직인다.
//
...
// ===== 탭 안에서만 도는 뒤로가기 =====
//
// 탭 안에서 뭔가를 열 때(보스 상세·코스튬 상세·도감 상세) 기록을 하나 쌓아 두고,
...
//
// 코스튬 뷰어를 켜 둔 채 캐릭터 도감에서 여러 명 넘겨 보면 딱 이 일이 난다 —
// 도감 쪽에서 한 명 볼 때마다 문맥이 하나씩 쌓이다가, 한도를 넘는 순간 제일 오래된
